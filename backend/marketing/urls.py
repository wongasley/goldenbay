...
from .views import AdminPostDetailView, AdminPostListCreateView, MarketingBlastView, PublicPostListView, PostDetailView
...
urlpatterns = [
    ...
    path('manage/blast/', MarketingBlastView.as_view()),
]