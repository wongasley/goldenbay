...
const ManageBookingPage = lazy(() => import('./pages/public/reservations/ManageBookingPage'));
            ...
            <ErrorBoundary>
              <Suspense fallback={<PageLoader />}>
                <Routes>
                  ...
                  <Route path="/manage-booking/:token" element={<><Navbar /><ManageBookingPage /><Footer /></>} />
