...
const MenuPage = () => {
  ...
  const MenuSkeleton = () => (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-6 py-12 md:px-24">
      {[...Array(6)].map((_, i) => (
        <motion.div key={i} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: i * 0.1 }} className="bg-white border border-gray-200 rounded-sm overflow-hidden flex flex-col shadow-sm">
          <div className="aspect-[4/3] bg-gray-200 animate-pulse"></div>
          <div className="p-6 flex-1 flex flex-col gap-4">
            <div className="h-6 bg-gray-200 animate-pulse rounded w-3/4 mx-auto"></div>
