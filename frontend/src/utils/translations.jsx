...
export const translations = {
    en: {
        ...
        reservation: { 
            title: "Reservations", details: "Details", selectPref: "Select your preferred date and experience.", bookWechat: "Book via WeChat / WhatsApp", 
            vipRooms: "VIP Private Rooms", alaCarte: "Ala Carte Dining", checking: "Checking availability...", confirmTitle: "Confirm Details", 
            fName: "Full Name", fContact: "Contact / WhatsApp", fEmail: "Email (Optional)", fGuests: "Number of Guests", fTime: "Arrival Time", 
            selTime: "Select Preferred Time", fNotes: "Special Request / Menu Preferences", proc: "Processing Request...", reqRes: "Request Reservation", 
            wechatTitle: "WeChat / WhatsApp", scan: "Scan a code to chat directly with our reservation specialist.", retWeb: "Return to Web Booking", 
            reqPend: "Request Pending", rev: "We are reviewing your details", allow: "Please allow up to 30 minutes for confirmation during operating hours. Requests made after hours will be confirmed the following morning.", 
            retHome: "Return to Home",
            nextSelectTable: "Next: Select Table",
            nextFinalDetails: "Next: Final Details",
            back: "Back",
    ...
    zh: {
        ...
        events: { 
            title: "活动咨询", subtitle: "为生命中最重要的时刻提供顶级场地", headline: "为您传承打造的壮丽舞台。",
            ...
            milestones: "我们举办的盛事", milestonesDesc: "为您的特殊场合量身定制的专属服务和精选菜单。",
            ...
            capacities: "场地容量", venueSpecs: "场地详细规格", space: "宴会空间", banquet: "晚宴人数", cocktail: "鸡尾酒会", amenities: "配套设施",
            hallName: "豪华大宴会厅", hallDesc: "舞台、LED墙、全套音响", miniHall: "主餐厅（定制空间）", miniDesc: "视听设备、自助餐区",
            vipManila: "马尼拉顶级贵宾房", vipDesc: "私人卫生间、KTV系统", consultation: "专属咨询", connect: "开始策划您的活动", 
        ...
        reservation: { 
            title: "预订座位", details: "预订详情", selectPref: "选择您的首选日期和体验。", bookWechat: "通过微信 / WhatsApp预订", 
            vipRooms: "贵宾包厢", alaCarte: "大厅散座", checking: "正在查询...", confirmTitle: "确认详情", 
            fName: "全名", fContact: "联系电话 / WhatsApp", fEmail: "电子邮件 (选填)", fGuests: "就餐人数", fTime: "预计到达时间", 
            selTime: "选择时间", fNotes: "特殊要求 / 饮食偏好", proc: "处理中...", reqRes: "提交预订", 
            wechatTitle: "微信 / WhatsApp", scan: "扫描二维码，直接与我们的预订专员沟通。", retWeb: "返回网页预订", 
            reqPend: "预订已提交", rev: "我们正在审核您的预订信息", allow: "营业时间内请预留最多30分钟以便我们确认。非营业时间的预订将在次日上午处理。", 
            retHome: "返回首页",
            nextSelectTable: "下一步：选择餐桌",
            nextFinalDetails: "下一步：最终详情",
            back: "返回",
    ...
    zh_hant: {
        ...
        events: { 
            title: "活動諮詢", subtitle: "為生命中最重要的時刻提供頂級場地", headline: "為您傳承打造的壯麗舞台。",
            ...
            milestones: "我們舉辦的盛事", milestonesDesc: "為您的特殊場合量身定制的專屬服務和精選菜單。",
            ...
            capacities: "場地容量", venueSpecs: "場地詳細規格", space: "宴會空間", banquet: "晚宴人數", cocktail: "雞尾酒會", amenities: "配套設施",
            hallName: "豪華大宴會廳", hallDesc: "舞台、LED牆、全套音響", miniHall: "主餐廳（定制空間）", miniDesc: "視聽設備、自助餐區",
            vipManila: "馬尼拉頂級貴賓房", vipDesc: "私人衛生間、KTV系統", consultation: "專屬諮詢", connect: "開始策劃您的活動", 
        ...
        reservation: { 
            title: "預訂座位", details: "預訂詳情", selectPref: "選擇您的首選日期和體驗。", bookWechat: "通過微信 / WhatsApp預訂", 
            vipRooms: "貴賓包廂", alaCarte: "大廳散座", checking: "正在查詢...", confirmTitle: "確認詳情", 
            fName: "全名", fContact: "聯繫電話 / WhatsApp", fEmail: "電子郵件 (選填)", fGuests: "就餐人數", fTime: "預計到達時間", 
            selTime: "選擇時間", fNotes: "特殊要求 / 飲食偏好", proc: "處理中...", reqRes: "提交預訂", 
            wechatTitle: "微信 / WhatsApp", scan: "掃描此二維碼，直接與我們的預訂專員溝通。", retWeb: "返回網頁預訂", 
            reqPend: "預訂已提交", rev: "我們正在審核您的預訂信息", allow: "營業時間內請預留最多30分鐘以便我們確認。非營業時間的預訂將在次日上午處理。", 
            retHome: "返回首頁",
            nextSelectTable: "下一步：選擇餐桌",
            nextFinalDetails: "下一步：最終詳情",
            back: "返回",
            backToFloorPlan: "返回樓層平面圖",
            bookingSummary: "預訂摘要",
            session: "時段"
        }
    },
    ja: {
        ...
        events: { 
            title: "イベントのお問い合わせ", subtitle: "人生の最高の瞬間を祝うための会場", headline: "あなたのレガシーのための壮大なステージ。",
            ...
            milestones: "私たちが祝うマイルストーン", milestonesDesc: "特別な機会に合わせて完璧に調整された特注のサービスと厳選されたメニュー。",
            ...
            capacities: "収容人数", venueSpecs: "会場の仕様", space: "ファンクションスペース", banquet: "バンケット (着席)", cocktail: "カクテル (立食)", amenities: "主な設備",
            hallName: "グランドバンケットホール", hallDesc: "ステージ、LEDウォール、フルオーディオ", miniHall: "メインダイニング (ミニバンケット)", miniDesc: "AV機器対応、ビュッフェエリア",
            vipManila: "VIPマニラスイート", vipDesc: "専用トイレ、KTVシステム", consultation: "ご相談", connect: "イベントの計画を始める", 
        ...
        reservation: { 
            title: "ご予約", details: "詳細", selectPref: "ご希望の日付と体験を選択してください。", bookWechat: "WeChat / WhatsApp で予約", 
            vipRooms: "VIP個室", alaCarte: "アラカルトダイニング", checking: "空き状況を確認中...", confirmTitle: "詳細を確認", 
            fName: "フルネーム", fContact: "連絡先 / WhatsApp", fEmail: "メールアドレス (任意)", fGuests: "ゲストの数", fTime: "到着時間", 
            selTime: "希望の時間を選択", fNotes: "特別なご要望 / メニューの好み", proc: "リクエストを処理中...", reqRes: "予約をリクエストする", 
            wechatTitle: "WeChat / WhatsApp", scan: "このコードをスキャンして、予約スペシャリストと直接チャットしてください。", retWeb: "Web予約に戻る", 
            reqPend: "リクエスト保留中", rev: "詳細を確認しています", allow: "営業時間内のご予約は、確認まで最大30分ほどお待ちください。営業時間外のリクエストは翌朝処理されます。", 
            retHome: "ホームに戻る",
            nextSelectTable: "次へ：テーブルを選択",
            nextFinalDetails: "次へ：最終詳細",
            back: "戻る",
            backToFloorPlan: "フロアプランに戻る",
    ...
    ko: {
        ...
        events: { 
            title: "이벤트 문의", subtitle: "인생 최고의 순간을 위한 장소", headline: "당신의 레거시를 위한 장엄한 무대.",
            ...
            milestones: "우리가 기념하는 마일스톤", milestonesDesc: "특별한 행사를 위해 완벽하게 맞춤화된 서비스와 엄선된 메뉴.",
            ...
            capacities: "수용 인원", venueSpecs: "행사장 사양", space: "행사 공간", banquet: "연회 (착석)", cocktail: "칵테일 (스탠딩)", amenities: "주요 시설",
            hallName: "그랜드 연회장", hallDesc: "무대, LED 월, 풀 오디오 시스템", miniHall: "메인 다이닝 (미니 연회)", miniDesc: "AV 장비 완비, 뷔페 구역",
            vipManila: "VIP 마닐라 스위트", vipDesc: "전용 화장실, KTV 시스템", consultation: "상담", connect: "이벤트 기획 시작하기", 
        ...
        reservation: { 
            title: "예약", details: "세부 정보", selectPref: "원하는 날짜와 경험을 선택하십시오.", bookWechat: "WeChat / WhatsApp 예약", 
            vipRooms: "VIP 프라이빗 룸", alaCarte: "알라카르트 다이닝", checking: "예약 가능 여부 확인 중...", confirmTitle: "세부 정보 확인", 
            fName: "성명", fContact: "연락처 / WhatsApp", fEmail: "이메일 (선택 사항)", fGuests: "게스트 수", fTime: "도착 시간", 
            selTime: "원하는 시간 선택", fNotes: "특별 요청 / 메뉴 기본 설정", proc: "요청 처리 중...", reqRes: "예약 요청", 
            wechatTitle: "WeChat / WhatsApp", scan: "이 코드를 스캔하여 예약 전문가와 직접 채팅하십시오.", retWeb: "웹 예약으로 돌아가기", 
            reqPend: "요청 대기 중", rev: "세부 정보를 검토 중입니다", allow: "영업 시간 중 예약 확인에는 최대 30분이 소요됩니다. 영업 시간 외 요청은 다음 날 아침에 처리됩니다.", 
            retHome: "홈으로 돌아가기",
            nextSelectTable: "다음: 테이블 선택",
            nextFinalDetails: "다음: 최종 세부 정보",
            back: "뒤로",
            backToFloorPlan: "평면도로 돌아가기",
